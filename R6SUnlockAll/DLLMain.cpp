...
)
{
	...
	case(DLL_PROCESS_ATTACH):
		UnknowCallBack_t = (decltype(UnknowCallBack_t))(*(UINT_PTR*)(GameBaseAddr + 0x554BDB0));
		*(UINT_PTR*)(GameBaseAddr + 0x554BDB0) = (UINT_PTR)UnknowCallBack;
		break;
	case(DLL_PROCESS_DETACH):
		*(UINT_PTR*)(GameBaseAddr + 0x554BDB0) = (UINT_PTR)UnknowCallBack_t;
		break;
	}
