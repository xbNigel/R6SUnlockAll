...
UINT_PTR UnknowCallBack(UINT_PTR rcx, UINT_PTR rdx, UINT_PTR r8)
{
	...
	if ((UINT_PTR)_ReturnAddress() == (0x1EC6E19 + GameBaseAddr))
	{
...
)
{
	...
	case(DLL_PROCESS_ATTACH):
		UnknowCallBack_t = (decltype(UnknowCallBack_t))(*(UINT_PTR*)(GameBaseAddr + 0x5543F70));
		*(UINT_PTR*)(GameBaseAddr + 0x5543F70) = (UINT_PTR)UnknowCallBack;
		break;
	case(DLL_PROCESS_DETACH):
		*(UINT_PTR*)(GameBaseAddr + 0x5543F70) = (UINT_PTR)UnknowCallBack_t;
		break;
	}
